...
while  True :
    ...
    if data :
        ...
        ##Moving the drone
        if json_data: 
            print("Vehicle starts going to", json_data["movement"])
            if json_data["movement"] == "forward":
                send_ned_velocity(vehicle, ground_speed, 0, 0, 1)
            elif json_data["movement"] == "stop":
